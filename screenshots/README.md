...
Esta carpeta está vacía a propósito: el sitio no incluye capturas fabricadas o inventadas,
porque el entorno donde se generaron los tableros no tiene acceso a la app/web real de
Burger King (evaluación honesta > captura falsa).

Cada tarjeta de `index.html` busca automáticamente un archivo con el nombre exacto
